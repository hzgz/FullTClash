...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/opt/hostedtoolcache/Python/3.11.9/x64/bin',
 'BINLIBDEST': '/opt/hostedtoolcache/Python/3.11.9/x64/lib/python3.11',
 'BLDLIBRARY': '-L. -lpython3.11',
 'BLDSHARED': 'gcc -pthread -shared '
              '-Wl,--rpath=/opt/hostedtoolcache/Python/3.11.9/x64/lib '
              '-Wl,--rpath=/opt/hostedtoolcache/Python/3.11.9/x64/lib',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-fno-semantic-interposition -std=c11 -Wextra '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-Wl,--rpath=/opt/hostedtoolcache/Python/3.11.9/x64/lib',
 'CONFIGURE_LDFLAGS_NODIST': '-fno-semantic-interposition',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--prefix=/opt/hostedtoolcache/Python/3.11.9/x64' "
                "'--enable-shared' '--enable-optimizations' "
                "'--enable-loadable-sqlite-extensions' "
                "'LDFLAGS=-Wl,--rpath=/opt/hostedtoolcache/Python/3.11.9/x64/lib'",
 'CONFINCLUDEDIR': '/opt/hostedtoolcache/Python/3.11.9/x64/include',
 'CONFINCLUDEPY': '/opt/hostedtoolcache/Python/3.11.9/x64/include/python3.11',
 'COREPYTHONPATH': '',
 ...
 'DESTDIRS': '/opt/hostedtoolcache/Python/3.11.9/x64 '
             '/opt/hostedtoolcache/Python/3.11.9/x64/lib '
             '/opt/hostedtoolcache/Python/3.11.9/x64/lib/python3.11 '
             '/opt/hostedtoolcache/Python/3.11.9/x64/lib/python3.11/lib-dynload',
 'DESTLIB': '/opt/hostedtoolcache/Python/3.11.9/x64/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/opt/hostedtoolcache/Python/3.11.9/x64/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/opt/hostedtoolcache/Python/3.11.9/x64/include '
                   '/opt/hostedtoolcache/Python/3.11.9/x64/include '
                   '/opt/hostedtoolcache/Python/3.11.9/x64/include/python3.11 '
                   '/opt/hostedtoolcache/Python/3.11.9/x64/include/python3.11',
 'INCLUDEDIR': '/opt/hostedtoolcache/Python/3.11.9/x64/include',
 'INCLUDEPY': '/opt/hostedtoolcache/Python/3.11.9/x64/include/python3.11',
 ...
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/opt/hostedtoolcache/Python/3.11.9/x64/lib/python3.11',
 'LIBDIR': '/opt/hostedtoolcache/Python/3.11.9/x64/lib',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/opt/hostedtoolcache/Python/3.11.9/x64/lib/pkgconfig',
 'LIBPL': '/opt/hostedtoolcache/Python/3.11.9/x64/lib/python3.11/config-3.11-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/opt/hostedtoolcache/Python/3.11.9/x64/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/opt/hostedtoolcache/Python/3.11.9/x64/share/man',
 ...
 'PY_CORE_LDFLAGS': '-Wl,--rpath=/opt/hostedtoolcache/Python/3.11.9/x64/lib '
                    '-Wl,--rpath=/opt/hostedtoolcache/Python/3.11.9/x64/lib '
                    '-fno-semantic-interposition',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-Wl,--rpath=/opt/hostedtoolcache/Python/3.11.9/x64/lib '
               '-Wl,--rpath=/opt/hostedtoolcache/Python/3.11.9/x64/lib',
 'PY_LDFLAGS_NODIST': '-fno-semantic-interposition',
 'PY_LDFLAGS_NOLTO': '-Wl,--rpath=/opt/hostedtoolcache/Python/3.11.9/x64/lib '
                     '-Wl,--rpath=/opt/hostedtoolcache/Python/3.11.9/x64/lib',
 ...
 'SCRIPTDIR': '/opt/hostedtoolcache/Python/3.11.9/x64/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './opt/hostedtoolcache/Python/3.11.9/x64',
 'WASM_STDLIB': './opt/hostedtoolcache/Python/3.11.9/x64/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'datarootdir': '/opt/hostedtoolcache/Python/3.11.9/x64/share',
 'exec_prefix': '/opt/hostedtoolcache/Python/3.11.9/x64',
 'prefix': '/opt/hostedtoolcache/Python/3.11.9/x64',
 'srcdir': '.'}
